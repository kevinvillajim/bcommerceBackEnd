...
class CorsTest extends Command
{
    ...
    private function testPreflightRequests($baseUrl)
    {
    ...
    private function testSinglePreflight($url, $origin, $method)
    {
        try {
    ...
    private function testCorsRequests($baseUrl)
    {
    ...
    private function testSingleRequest($test)
    {
        try {
