...
class CheckoutRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'shipping.required' => 'La información de envío es requerida.',
            'shipping.first_name.required' => 'El nombre es requerido.',
            'shipping.last_name.required' => 'El apellido es requerido.',
            'shipping.email.required' => 'El email es requerido.',
            'shipping.email.email' => 'Debe proporcionar un email válido.',
            'shipping.phone.required' => 'El teléfono es requerido.',
